  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: BG, fontFamily: "'Segoe UI', sans-serif", color: '#333' }}>
      ...
      <section id="cardapio" style={{ padding: '50px 20px', maxWidth: '980px', margin: '0 auto' }}>
        ...
        {filterCats.length > 1 && (
          <div style={{ display: 'flex', gap: '8px', overflowX: 'auto', paddingBottom: '14px', marginBottom: '28px', scrollbarWidth: 'none' }}>
            {filterCats.map(cat => (
      ...
      {showAdmin && (
        <div style={{ position: 'fixed', inset: 0, zIndex: 200, display: 'flex' }}>
          ...
          <div style={{ width: '370px', maxWidth: '100vw', background: 'white', height: '100%', overflowY: 'auto', boxShadow: '-4px 0 24px rgba(0,0,0,0.15)', display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ display: 'flex', overflowX: 'auto', borderBottom: '1px solid #f0d0da', flexShrink: 0, scrollbarWidth: 'none' }}>
            ...
            <div style={{ padding: '20px', flex: 1 }}>
              ...
              {adminTab === 'banner' && (
                <div>
                  ...
                  <textarea style={{ ...inp, resize: 'none' }} rows={3} value={editBanner.texto} onChange={e => setEditBanner({ ...editBanner, texto: e.target.value })} />
                  ...
                  <input style={inp} placeholder="Deixe vazio para ir ao WhatsApp" value={editBanner.link} onChange={e => setEditBanner({ ...editBanner, link: e.target.value })} />
